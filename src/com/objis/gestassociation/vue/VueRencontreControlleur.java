...
public class VueRencontreControlleur implements Initializable {
    ...
    public void clickerSurBtnAjouterEnr() {
        ...
        association.getListeRencontre().add(Rencontre);
    ...
    public void clickerSurBtnReset() {
        ...
        if (association.getListeMbBureauPresentRencontre() != null) {
            association.getListeMbBureauPresentRencontre().clear();
        }

        if (association.getListeAdherentPresentRencontre() != null) {
            association.getListeAdherentPresentRencontre().clear();
        }
    ...
    public void addMbBureau() {
        ...
        association.getListeMbBureauPresentRencontre().add(cbxMbBureau.getSelectionModel().getSelectedItem());
    ...
    public void deleteMbBureau() {
        ...
        association.getListeMbBureauPresentRencontre().remove(tableMbBureau.getSelectionModel().getFocusedIndex());
    ...
    public void addAdherent() {
        ...
        association.getListeAdherentPresentRencontre().add(cbxAdherent.getSelectionModel().getSelectedItem());
    ...
    public void suppAdherent() {
        ...
        association.getListeAdherentPresentRencontre().remove(tableAdherent.getSelectionModel().getSelectedIndex());
    ...
    public void setGestionAssociation(GestionAssociation association) {
        ...
        this.tableRencontre.setItems(association.getListeRencontre());
        this.tableMbBureau.setItems(association.getListeMbBureauPresentRencontre());
        this.tableAdherent.setItems(association.getListeAdherentPresentRencontre());
    }
