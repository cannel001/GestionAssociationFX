...
/**
 * Classe Bureau DaoWebService
 *
 * @author Seka Cannel Ulrich Evrard
 *
 */
public class BureauDaoWebService extends DaoWebService<Bureau, Long> {
    ...
    /**
     * methode permettant de retourner un membre en fonction du login et du mot
     * de passe
     *
     * @param login
     * @param password
    ...
    /**
     * methode permettant de verifier l'existance d'un login dans la base de
     * données
     *
     * @param login
     * @return
