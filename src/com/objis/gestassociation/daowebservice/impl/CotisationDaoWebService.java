...
/**
 * Classe Cotisation DaoWebService
 *
 * @author Seka Cannel Ulrich Evrard
 *
 */
public class CotisationDaoWebService extends DaoWebService<Cotisation, Long> {
    ...
    /**
     * methode permettant de retourner la liste des cotisations par année et par
     * Id
     *
     * @param id
     * @param dateDebut
