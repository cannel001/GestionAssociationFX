...
/**
 *
 * @author Seka Cannel Ulrich evrard Classe adherent service
 *
 */
public class AdherentService implements IAdherentService {
    ...
    /**
     * methode permettant de retourner le nombre d'enregistrement par matricule
     * redefinie
     */
    @Override
    ...
    /**
     * methode permettant de verifier l'existence d'adherent dans la table
     * bureau redefinie
     */
    @Override
    ...
    /**
     * methode permettant de verifier l'existence d'un adherent dans la table
     * cotisation redefinie
     */
    @Override
